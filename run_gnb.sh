#!/bin/bash
#
# This script is a shortcut to start the software modem for OAI gNB.
...
CONFIG_FILE="./targets/PROJECTS/GENERIC-NR-5GC/CONF/gnb.sa.band78.fr1.106PRB.usrpb210.conf"
